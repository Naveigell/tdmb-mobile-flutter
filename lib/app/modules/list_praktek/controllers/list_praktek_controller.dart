...
import 'package:tdmb2/app/modules/list_praktek/providers/list_praktek_provider.dart';
...
class ListPraktekController extends GetxController {
  ...
  Future<void> listCerita(int pgno, String judul) {
    return ListPraktekProvider().listCerita(judul, pgno).then((response) {
